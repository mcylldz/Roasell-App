...
const HeroDescriptions = () => (
  <div className="space-y-3">
    <p className="text-sm sm:text-base lg:text-lg text-zinc-400 leading-relaxed font-medium border-l-2 border-blue-600/50 pl-4 break-words">
      Hangi reklamın para kaybettirdiğini, hangisinin ölçeklenmesi gerektiğini yapay zeka sana söylüyor. Ajansa, uzmana veya tahmine gerek yok — veriye dayalı aksiyonlar 7/24 önünde.
    </p>
    <div className="flex items-start gap-2 pl-4 text-blue-400 font-bold text-xs sm:text-sm italic">
      <Shield size={14} className="shrink-0 mt-0.5" />
      <span className="break-words">Ajansa bağımlılığını bitir. Reklamlarını kendin yönet, yapay zeka sana yol göstersin.</span>
    </div>
  </div>
);
        ...
        <div className="hidden lg:flex lg:flex-col gap-10 mt-12">
          ...
          <div className="flex flex-col items-center gap-5 w-full text-center">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg glass border-blue-500/20 text-blue-400 text-[10px] font-bold mono tracking-widest uppercase w-fit">
              ...
              7 Yıllık Veri ile Eğitilmiş Reklam Analiz Motoru
            </div>
            <h1 className="text-3xl lg:text-4xl xl:text-5xl font-extrabold tracking-tighter leading-[0.95] text-white text-center">
              ...
              <span className="text-zinc-600">Artık bileceksin.</span>
            </h1>
            <p className="text-base text-zinc-400 max-w-2xl text-center">
              Meta reklamlarını analiz eden yapay zeka, sana her gün net aksiyonlar söyler: <strong className="text-white">aç, kapat, ölçekle.</strong>
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-14 items-start">
            ...
            {/* RIGHT — Risk Kontrol Paneli + 2.metin + CTA + Badges + ARAÇ */}
            <div className="flex flex-col gap-6 min-w-0">
                ...
                <div className="relative glass rounded-2xl p-6 border border-white/10 shadow-2xl bg-[#080808]/40 backdrop-blur-3xl overflow-hidden">
                  ...
                  <div className="flex justify-between items-center mb-6">
                    <div className="space-y-1 min-w-0">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-[10px] font-black mono text-zinc-500 uppercase tracking-widest truncate">Hızlı Başlangıç Planı;</span>
                      </div>
                      <h3 className="text-lg font-black tracking-tight uppercase italic">Risk Kontrol Paneli</h3>
                    </div>
                  ...
                  <div className="mt-5 p-4 rounded-lg bg-blue-500/10 border border-blue-500/20 relative group overflow-hidden">
                    ...
                    <div className="flex items-center gap-2 mb-1.5">
                      ...
                      <span className="text-[10px] font-black text-blue-400 uppercase tracking-widest">İPUCU;</span>
                    </div>
              ...
              {/* 2. metin + CTA + Badges + ARAÇ — Risk Panelinin altında */}
              <div className="flex flex-col gap-5">
                <div className="flex items-start gap-2 pl-4 text-blue-400 font-bold text-sm italic">
                  <Shield size={14} className="shrink-0 mt-0.5" />
                  <span>Ajansa bağımlılığını bitir. Reklamlarını kendin yönet, yapay zeka sana yol göstersin.</span>
                </div>
                <button
